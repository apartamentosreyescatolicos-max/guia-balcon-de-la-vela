/* =========================================================
   Guía El Balcón de la Vela · interacciones del cliente
   ========================================================= */
...
(() => {
  ...
  const I18N = {
    es: {
      ...
      'house.ac.t': 'Aire acondicionado (solo frío) y radiador',
      'house.ac.d': 'El aire acondicionado solo enfría: úsalo con el mando para refrescar el apartamento. Para calefacción, hay un radiador en la pared con su propio interruptor.',
      ...
      'move.walk.t': 'A pie',
      'move.walk.d': 'El apartamento está en plena Plaza Nueva, en el corazón histórico. La Catedral, la Capilla Real, el Paseo de los Tristes y el Albaicín están a pocos minutos andando. Calzado cómodo: Granada tiene cuestas y empedrado.',
      ...
      'footer.sign': 'Apartamentos Reyes Católicos · Plaza Nueva · Granada',
    ...
    en: {
      ...
      'house.ac.t': 'Air conditioning (cooling only) and radiator',
      'house.ac.d': 'The AC unit only cools — use the remote to refresh the apartment. For heating, there is a radiator on the wall with its own switch.',
      ...
      'move.walk.t': 'On foot',
      'move.walk.d': 'The apartment is right on Plaza Nueva, in the historic centre. The Cathedral, the Royal Chapel, Paseo de los Tristes and the Albaicín are just a few minutes away on foot. Wear comfy shoes — Granada has slopes and cobblestones.',
      'move.bus.t': 'City bus',
  ...
  function applyLang(lang) {
    ...
    try { localStorage.setItem('balconvela.lang', lang); } catch (_) {}
  }
  ...
  let savedLang = null;
  try { savedLang = localStorage.getItem('balconvela.lang'); } catch (_) {}
